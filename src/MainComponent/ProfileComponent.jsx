...
} from "./FriendStatusContentDetailsComponent";

import {
  LoadingComponent,
} from "../SideComponent/LoadingComponent";

import {
  NotListComponent,
} from "../SideComponent/NoListComponent";

import {
  formatTimeStamp,
} from "../configs/configTimeStamp";

import {
  decodeJwt,
} from "../SideFunction/VerifyJwtGetUserInfo.js";

import {
  MyStatusAreaComponent,
} from "./MyStatusAreaComponent.jsx";

import {
  ModalComponent,
} from "../SideComponent/ModalComponent.jsx";

import {
  useFacadeMyProfileList,
} from "../reduxs/useFacadeMyStatusProfile.jsx";

import {
  checkValueInArrayGetData,
} from "../SideFunction/CheckValueInArray.js";
      ...
      async (postId) => {
        try {
          ...
          const imagesToDelete =
            originalPostImages.filter(
              (
                originalKey,
              ) =>
                !keptExistingKeys.includes(
                  originalKey,
                ),
            );
                          ...
                          >
                            <Button
                              style={{
                                ...
                                backgroundColor:
                                  "#FFFFFF",
                                border: `1px solid ${item.likestatus
                                  ? "red"
                                  : "#D9D9D9"
                                  }`,
                              }}
